...
Expresiones regulares:
    Son una secuencia de caracteres que forma un patrón de búsqueda, principalmente utilizada para la busquea de patrones de cadenas de caracteres u operaciones de sustituciones.

Sintaxis:
    /patron/
Banderas:
    i: ignore case: No diferencia entre maysuculas y minúsculas
...
console.log(tex.includes('Lorem'));