...
Insertar y eliminar elementos II
    ...
    positions:
        ...
        afterbegin -Despúes de que empiece (primer hijo)
        beforeend - Antes de que acabe (último hijo)
        afterend - Despúes de que acabe (hermano siguiente)
...
/* 
    ...
    positions:
        ...
        parent.prepend() -Despúes de que empiece (primer hijo)
        parent.append() - Antes de que acabe (último hijo)
        parent.after() - Despúes de que acabe (hermano siguiente)

        child.repleceWith(newChild)
*/
...
/* 
    Clonar y eliminar elementos
        element.cloneNode(true|false) - Clona el nodo. Si le pasamos true clona el elemento con los hijos, si le pasamos false clona solo el elemento sin hijos
