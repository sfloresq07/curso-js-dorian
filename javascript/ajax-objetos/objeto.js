...
console.log(Math.round(Math.random()*100)); /* igual que el anterior  aleatorio pero redondeando (sin decimales) */

/* console.log(Math.random() * (max - min) + min);   generar un numero aleatorio entre un minimo y un maximo */

console.log(Math.random() * (10 - 5) + 5);

console.log(Math.round(Math.random() * (10 - 5) + 5)); /* igual que el anterior  aleatorio pero redondeando (sin decimales) */
